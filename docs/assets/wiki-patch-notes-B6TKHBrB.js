...
var _WikiPatchNotes_decorators, _init;
_WikiPatchNotes_decorators = [customElement(__au2ViewDef)];
class WikiPatchNotes {
  notes = patchNotesJson.notes;
}
_init = __decoratorStart();
WikiPatchNotes = __decorateElement(_init, 0, "WikiPatchNotes", _WikiPatchNotes_decorators, WikiPatchNotes);
__runInitializers(_init, 1, WikiPatchNotes);
export {
  WikiPatchNotes
};
