...
var _WikiBuildDetail_decorators, _init;
_WikiBuildDetail_decorators = [customElement(__au2ViewDef)];
class WikiBuildDetail {
  page = null;
  loading(params) {
    const cls = params.class;
    const buildSlug = params.build;
    const classData = buildsJson[cls];
    if (classData) {
...
WikiBuildDetail = __decorateElement(_init, 0, "WikiBuildDetail", _WikiBuildDetail_decorators, WikiBuildDetail);
__runInitializers(_init, 1, WikiBuildDetail);
export {
  WikiBuildDetail
};
