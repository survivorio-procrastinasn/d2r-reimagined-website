...
var _WikiItems_decorators, _init;
const itemList = [
...
_WikiItems_decorators = [customElement(__au2ViewDef)];
class WikiItems {
  items = itemList;
}
_init = __decoratorStart();
WikiItems = __decorateElement(_init, 0, "WikiItems", _WikiItems_decorators, WikiItems);
__runInitializers(_init, 1, WikiItems);
export {
  WikiItems
};
